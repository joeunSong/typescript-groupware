...
//       className={`flex w-full items-center h-[50px] p-[16px] border-solid ${tableData.rowIndex === 0 ? 'border-t-[1px]' : ''} border-b-[1px] border-gray-200`}
//     >
//       <span className='text-base truncate'>{rowData?.requestUser?.department?.title}</span>
//     </div>
//   );
// };
...
// export const CustomEditDate = (rowData: any, tableData: any) => {
//   return (
//     <div
//       title={rowData.id}
//       className={`flex w-full items-center h-[50px] p-[16px] border-solid ${tableData.rowIndex === 0 ? 'border-t-[1px]' : ''} border-b-[1px] border-gray-200`}
...
//         {moment(rowData?.commute?.startAt).format('YYYY-MM-DD hh:mm:ss')} ~ {moment(rowData?.commute?.endAt).format('YYYY-MM-DD hh:mm:ss')}
//       </span>
//     </div>
//   );
// };

// export const CustomCreateDate = (rowData: any, tableData: any) => {
//   return (
//     <div
//       title={rowData.id}
//       className={`flex w-full items-center h-[50px] p-[16px] border-solid ${tableData.rowIndex === 0 ? 'border-t-[1px]' : ''} border-b-[1px] border-gray-200`}
//     >
//       <span className='text-base truncate'>{moment(rowData?.commute?.date).format('YYYY-MM-DD')}</span>
//     </div>
//   );
// };
